...
opam@89b04864d029:~$ sudo apt install build-essential libgmp-dev libsodium-dev pkg-config m4 libssl-dev libsqlite3-dev wget ca-certificates unzip libncurses-dev zlib1g-dev -y
...
build:
  ...
  script:
    ...
    - apt-get update -qq && apt-get install -y -qq build-essential libgmp-dev libsodium-dev pkg-config m4 libssl-dev libsqlite3-dev wget ca-certificates unzip libncurses-dev zlib1g-dev git
...
$ sudo apt-get update -qq && sudo apt-get install -y -qq build-essential libgmp-dev libsodium-dev pkg-config m4 libssl-dev libsqlite3-dev wget ca-certificates unzip libncurses-dev zlib1g-dev
$ opam install --yes ppx_yojson_conv zarith cryptokit calendar cmdliner sqlite3 eliom=6.3.0
$ exit
