...
Public credentials, sent to the server by the credential authority,
and published as part of public data, are a list of strings, each one
being:
\begin{itemize}
...
Additionally, we will denote throughout this document by $\varphi$
