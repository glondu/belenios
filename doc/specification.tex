...
The Ed25519 group is a well-known group, used in the eponymous
signature scheme. It is defined by the following parameters:
\begin{itemize}
\item $p=2^{255}-19$,
...
\begin{table}
  \begin{framed}
    ...
    \item $x\leftarrow\shatwo(\verb=ggen|=i)>>2$\hfill// $i$ in base 10,
      output as a big-endian number
    \item $h\leftarrow\textsf{uncompress}(x+\varepsilon)$
