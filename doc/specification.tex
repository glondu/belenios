...
Lists questions are represented nested in a \texttt{question\_gen}
structure (second alternative), where the \textsf{type} property is
set to \verb=Lists=, and the \textsf{value} property is set to a
\texttt{question\_l} structure. Such questions are suitable to elect
candidates grouped in lists. Here, $\answers$ is a vector of vectors
of strings with the shape:
