...
{\it Weights.}  In the homomorphic case, each voter has a weight: a
...
\item $\mathcal{V}_1,\dots,\mathcal{V}_n$: voters; each voter has a weight $w_i$
...
\item for homomorphic questions, each element of $C_i$
  ...
  ciphertext of all the ballots, elevated to the power of its weight:
  \[
