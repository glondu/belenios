...
uuid="--uuid $UUID"
group="--group group"
echo RFC-3526-2048 > group

# Generate credentials
belenios-tool credgen $uuid $group --count 50
...
belenios-tool mkelection $uuid $group --template $BELENIOS/tests/tool/templates/questions-stv.json
