...
def create_election_data_snapshot(election_id):
    ...
    subprocess.run(["cp", "election.json", "public_creds.json", "trustees.json", "ballots.jsons", temporary_folder_absolute_path], cwd=election_folder) # TODO: Execute a command that works on other OS, like `shutil.copy()`
