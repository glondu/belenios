...
let here = "hier"
let question_header = "Wählen Sie zwischen %d und %d Antworten aus"
...
let privacy_policy_short = "Datenschutzbestimmungen"
...
let with_the_jsquery = ", with the JavaScript query "
