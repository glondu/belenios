...
module type S = sig
  val uuid_and_token :
    (Web_serializable_t.uuid * string, [ `WithoutSuffix ],
     [ `One of Web_serializable_t.uuid ]
       Eliom_parameter.param_name * [ `One of string ] Eliom_parameter.param_name)
  ...
  val privacy_notice_accept :
    (unit, Web_common.privacy_cont, Eliom_service.post, Eliom_service.non_att,
     ...
     Eliom_service.non_ocaml)
      Eliom_service.t
  val site_login :
    (string option * Web_common.site_cont, unit, Eliom_service.get,
     Eliom_service.att, Eliom_service.non_co, Eliom_service.non_ext,
     Eliom_service.reg, [ `WithoutSuffix ],
     [ `One of string ] Eliom_parameter.param_name *
       [ `One of Web_common.site_cont ] Eliom_parameter.param_name, unit,
     Eliom_service.non_ocaml)
      Eliom_service.t
  val logout :
    (Web_common.site_cont, unit, Eliom_service.get, Eliom_service.att,
  ...
  val election_draft_questions_post :
    (Web_serializable_t.uuid, string * int, Eliom_service.post,
     Eliom_service.att, Eliom_service.co, Eliom_service.non_ext,
     Eliom_service.reg, [ `WithoutSuffix ],
     [ `One of Web_serializable_t.uuid ] Eliom_parameter.param_name,
     [ `One of string ] Eliom_parameter.param_name *
       [ `One of int ] Eliom_parameter.param_name, Eliom_service.non_ocaml)
      Eliom_service.t
  ...
  val election_draft_languages :
    (Web_serializable_t.uuid, string, Eliom_service.post, Eliom_service.att,
     Eliom_service.co, Eliom_service.non_ext, Eliom_service.reg,
     [ `WithoutSuffix ],
     [ `One of Web_serializable_t.uuid ] Eliom_parameter.param_name,
     [ `One of string ] Eliom_parameter.param_name, Eliom_service.non_ocaml)
  ...
  val election_draft_credentials :
    (Web_serializable_t.uuid * string, unit, Eliom_service.get,
     Eliom_service.att, Eliom_service.non_co, Eliom_service.non_ext,
     Eliom_service.reg, [ `WithSuffix ],
     [ `One of Web_serializable_t.uuid ] Eliom_parameter.param_name *
  ...
  val election_draft_credentials_post_file :
    (Web_serializable_t.uuid * string, Ocsigen_multipart.file_info,
     Eliom_service.post, Eliom_service.att, Eliom_service.non_co,
  ...
  val election_draft_threshold_set :
    (Web_serializable_t.uuid, int, Eliom_service.post, Eliom_service.att,
     Eliom_service.co, Eliom_service.non_ext, Eliom_service.reg,
     [ `WithoutSuffix ],
     [ `One of Web_serializable_t.uuid ] Eliom_parameter.param_name,
     [ `One of int ] Eliom_parameter.param_name, Eliom_service.non_ocaml)
  ...
  val set_cookie_disclaimer :
    (Web_common.site_cont, unit, Eliom_service.get, Eliom_service.non_att,
     Eliom_service.co, Eliom_service.non_ext, Eliom_service.reg,
     [ `WithoutSuffix ],
     [ `One of Web_common.site_cont ] Eliom_parameter.param_name, unit,
     Eliom_service.non_ocaml)
  ...
  val election_regenpwd_post :
    (Web_serializable_t.uuid, string, Eliom_service.post, Eliom_service.att,
     ...
     [ `One of string ] Eliom_parameter.param_name, Eliom_service.non_ocaml)
      Eliom_service.t
  val election_login :
    ((Web_serializable_t.uuid * unit) * string option, unit, Eliom_service.get,
     Eliom_service.att, Eliom_service.non_co, Eliom_service.non_ext,
     Eliom_service.reg, [ `WithSuffix ],
     ([ `One of Web_serializable_t.uuid ] Eliom_parameter.param_name *
    ...
    Booth :
      (unit ->
       (unit, unit, Eliom_service.get, Eliom_service.att,
        Eliom_service.non_co, Eliom_service.non_ext, 'reg,
        [ `WithoutSuffix ], unit, unit, Eliom_service.non_ocaml)
         Eliom_service.t) -> booth
  ...
  val election_submit_ballot :
    (unit, string, Eliom_service.post, Eliom_service.att, Eliom_service.non_co,
     Eliom_service.non_ext, Eliom_service.reg, [ `WithoutSuffix ], unit,
     [ `One of string ] Eliom_parameter.param_name, Eliom_service.non_ocaml)
      Eliom_service.t
  val election_submit_ballot_file :
    (unit, Ocsigen_multipart.file_info, Eliom_service.post, Eliom_service.att,
     Eliom_service.non_co, Eliom_service.non_ext, Eliom_service.reg,
     [ `WithoutSuffix ], unit,
     [ `One of Ocsigen_multipart.file_info ] Eliom_parameter.param_name,
     Eliom_service.non_ocaml)
  ...
  val election_pretty_ballot :
    ((Web_serializable_t.uuid * unit) * string, unit, Eliom_service.get,
     Eliom_service.att, Eliom_service.non_co, Eliom_service.non_ext,
     Eliom_service.reg, [ `WithSuffix ],
     ([ `One of Web_serializable_t.uuid ] Eliom_parameter.param_name *
        [ `One of unit ] Eliom_parameter.param_name) *
  ...
  val election_project_result :
    ((Web_serializable_t.uuid * unit) * int, unit, Eliom_service.get,
     Eliom_service.att, Eliom_service.non_co, Eliom_service.non_ext,
     Eliom_service.reg, [ `WithSuffix ],
     ([ `One of Web_serializable_t.uuid ] Eliom_parameter.param_name *
        [ `One of unit ] Eliom_parameter.param_name) *
       [ `One of int ] Eliom_parameter.param_name, unit, Eliom_service.non_ocaml)
      Eliom_service.t
  ...
  val election_shuffler_select :
    (unit, Web_serializable_t.uuid * string, Eliom_service.post,
  ...
  val election_tally_release :
    (Web_serializable_t.uuid, unit, Eliom_service.post, Eliom_service.att,
     ...
     Eliom_service.non_ocaml)
      Eliom_service.t
  val election_dir :
    (Web_serializable_t.uuid * Web_common.election_file, unit,
     Eliom_service.get, Eliom_service.att, Eliom_service.non_co,
     Eliom_service.non_ext, Eliom_service.reg, [ `WithSuffix ],
     [ `One of Web_serializable_t.uuid ] Eliom_parameter.param_name *
       [ `One of Web_common.election_file ] Eliom_parameter.param_name, unit,
     Eliom_service.non_ocaml)
      Eliom_service.t
  val dummy_post :
  ...
  val email_login_post :
    (unit, string, Eliom_service.post, Eliom_service.non_att, Eliom_service.co,
     Eliom_service.non_ext, Eliom_service.reg, [ `WithoutSuffix ], unit,
     [ `One of string ] Eliom_parameter.param_name, Eliom_service.non_ocaml)
      Eliom_service.t
  val password_post :
    (unit, string * (string * string), Eliom_service.post,
     ...
     Eliom_service.non_ocaml)
      Eliom_service.t
  val set_language :
    (string * Web_common.site_cont, unit, Eliom_service.get,
     Eliom_service.non_att, Eliom_service.co, Eliom_service.non_ext,
     Eliom_service.reg, [ `WithoutSuffix ],
     [ `One of string ] Eliom_parameter.param_name *
       [ `One of Web_common.site_cont ] Eliom_parameter.param_name, unit,
     Eliom_service.non_ocaml)
      Eliom_service.t
  val signup_captcha :
    (string, unit, Eliom_service.get, Eliom_service.att, Eliom_service.non_co,
     Eliom_service.non_ext, Eliom_service.reg, [ `WithoutSuffix ],
     [ `One of string ] Eliom_parameter.param_name, unit,
     Eliom_service.non_ocaml)
      Eliom_service.t
  val signup_captcha_post :
    (string, string * (string * string), Eliom_service.post, Eliom_service.att,
     Eliom_service.co, Eliom_service.non_ext, Eliom_service.reg,
  ...
  val signup :
    (unit, unit, Eliom_service.get, Eliom_service.att, Eliom_service.non_co,
     ...
     unit, Eliom_service.non_ocaml)
      Eliom_service.t
  val signup_post :
    (unit, string * (string * string), Eliom_service.post, Eliom_service.att,
     Eliom_service.co, Eliom_service.non_ext, Eliom_service.reg,
     [ `WithoutSuffix ], unit,
     [ `One of string ] Eliom_parameter.param_name *
       ([ `One of string ] Eliom_parameter.param_name *
  ...
  val changepw_captcha_post :
    (string, string * (string * (string * string)), Eliom_service.post,
     Eliom_service.att, Eliom_service.co, Eliom_service.non_ext,
     Eliom_service.reg, [ `WithoutSuffix ],
     [ `One of string ] Eliom_parameter.param_name,
     [ `One of string ] Eliom_parameter.param_name *
  ...
  val changepw_post :
    (unit, string * string, Eliom_service.post, Eliom_service.att,
     ...
     [ `One of string ] Eliom_parameter.param_name *
      ...
      Eliom_service.t
  val method_schulze :
    (Web_serializable_t.uuid * int, unit, Eliom_service.get, Eliom_service.att,
     Eliom_service.non_co, Eliom_service.non_ext, Eliom_service.reg,
     [ `WithoutSuffix ],
     [ `One of Web_serializable_t.uuid ] Eliom_parameter.param_name *
       [ `One of int ] Eliom_parameter.param_name, unit, Eliom_service.non_ocaml)
      Eliom_service.t
  val method_mj :
    (Web_serializable_t.uuid * (int * int option), unit, Eliom_service.get,
     Eliom_service.att, Eliom_service.non_co, Eliom_service.non_ext,
     Eliom_service.reg, [ `WithoutSuffix ],
     [ `One of Web_serializable_t.uuid ] Eliom_parameter.param_name *
