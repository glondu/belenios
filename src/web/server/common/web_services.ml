...
module Make () = struct
  ...
  let election_draft_trustee_del = create_attached_post ~csrf_safe:true ~fallback:election_draft ~post_params:(string "address") ()
  ...
  let election_draft_trustee = create ~path:(Path ["draft"; "trustee"]) ~meth:(Get (suffix uuid_and_token)) ()
  let election_draft_trustee_static = create ~path:(Path ["draft"; "trustee.html"]) ~meth:(Get unit) ()
  ...
  let election_draft_threshold_trustee_del = create_attached_post ~csrf_safe:true ~fallback:election_draft_threshold_trustees ~post_params:(string "address") ()
  ...
  let election_cast_confirm = create ~path:(Path ["election"; "confirm"]) ~meth:(Get (uuid "uuid")) ()
