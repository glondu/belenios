...
let election_draft_threshold_trustee_add = create_attached_post ~fallback:election_draft_threshold_trustees ~post_params:(string "id" ** string "name") ()
...
let election_shuffler_select = create ~path:No_path ~meth:(Post (unit, uuid "uuid" ** string "trustee")) ()
let election_shuffler_skip_confirm = create ~path:No_path ~meth:(Post (unit, uuid "uuid" ** string "trustee")) ()
let election_shuffler_skip = create ~path:No_path ~meth:(Post (unit, uuid "uuid" ** string "trustee")) ()
