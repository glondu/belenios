          ...
          if cred_auth_is_server then
            div [
                a ~service:election_draft_credentials_get
                  [pcdata "Download private credentials"] uuid
              ]
          else pcdata ""
        in
        div [
    ...
    if cred_auth_is_server && not private_creds_downloaded then
      span
        [
          ...
          pcdata " Please ";
          a ~service:election_draft_credentials_get [pcdata "download"] uuid;
          pcdata " and save them securely.";
        ]
    else
      ok "OK"
  in
      ...
      [
        ...
        tablex [tbody [
          tr [
            ...
            td [input ~a:[a_maxlength 100] ~input_type ~name string];
          ]]
        ];
        div [
      ...
      [
        ...
        tablex [tbody [
          tr [
            ...
            td [input ~a:[a_maxlength 100] ~input_type:`Text ~name:llogin string];
          ];
          tr [
