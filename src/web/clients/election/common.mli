...
val make_audit_footer : Election.t -> Html_types.div_content_fun elt
val clear_cache : unit -> unit
val get_election : uuid -> Election.t option Lwt.t
...
val get_ballots : uuid -> ballot_dynamic_records option Lwt.t
