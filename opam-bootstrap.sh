...
echo
opam install --yes base64 hex dune atdgen zarith cryptokit calendar cmdliner sqlite3 ocsipersist-sqlite-config eliom=11.1.1+belenios2 gettext-camomile ocamlnet ocamlformat "$@"
