...
*/
const majorityJudgmentGradesHslColorScale = [
  [121, 78, 27],
  [121, 59, 44],
  [105, 55, 60],
  [47, 91, 55],
...
const majorityJudgmentGradeIndexToCssColor = gradeIndexToCssColor.bind(
  null,
  majorityJudgmentGradesHslColorScale,
);

export {
  gradeIndexToCssColor,
  majorityJudgmentGradesHslColorScale,
  majorityJudgmentGradeIndexToCssColor,
};
